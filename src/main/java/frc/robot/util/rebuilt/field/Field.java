...
public class Field {
    ...
    public static class BlueBumps {
        ...
        public static final double bumpY = Units.inchesToMeters(255.0);
    }

    public static class LeftBlueBumps {
        public static final Translation2d nearLeftCorner =
            new Translation2d(BlueHub.centerX - BlueBumps.width / 2.0, BlueBumps.bumpY);

        public static final Translation2d nearRightCorner =
            BlueHub.nearLeftCorner;

        public static final Translation2d farLeftCorner =
            new Translation2d(BlueHub.centerX + BlueBumps.width / 2.0, BlueBumps.bumpY);

        public static final Translation2d farRightCorner =
            BlueHub.farLeftCorner;
    }
    ...
    public static class BlueTower {
        ...
        public static final Translation2d center =
            new Translation2d(frontFaceX, tag31Y);
    ...
    @Getter public static final Translation3d blueHubCenter = BlueHub.topCenter; //new Translation3d(
            // Units.inchesToMeters(182.11),
            // Units.inchesToMeters(158.84),
            // Units.inchesToMeters(72));
    @Getter public static final Translation3d redHubCenter = BlueToRed(BlueHub.topCenter); //new Translation3d(
