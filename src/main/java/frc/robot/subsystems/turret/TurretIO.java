...
public interface TurretIO {
    ...
    public static class TurretIOInputs {
        ...
        public double absPositionTours1 = 0.0; // Raw Absolute position from absolute encoder 1
        public double absPositionTours2 = 0.0; // Raw Absolute position from absolute encoder 2
    ...
    public default TurretAngleCalculator getAngleCalculator() {
        return null;
    }
