...
/**
 * Module IO implementation for Spark Flex drive motor controller, Spark Max turn motor controller, and thrifty absolute
 * encoder.
 */
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        turnSpark = new SparkMax(
                ...
                MotorType.kBrushless);
        turnAbsEncoder = new AnalogInput(
                switch (module) {
        ...
        tryUntilOk(
                ...
                () -> turnEncoder.setPosition(
                        (turnAbsEncoder.getAverageVoltage() / RobotController.getVoltage5V()) * 2 * Math.PI)); // If
        // inverted
        // is
        // true,
        // *
